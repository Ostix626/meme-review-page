...
if (!isset($_SESSION['user'])) {
  ...
  echo '<div class="dropdown">';
    ...
    echo '<div class="dropdown-content">';
      echo '<a href="category.php?category=Star Wars">Star Wars</a>';
      echo '<a href="category.php?category=Shrek">Shrek</a>';
      echo '<a href="category.php?category=Domaci">Domaci</a>';
      echo '<a href="category.php?category=Animals">Animals</a>';
